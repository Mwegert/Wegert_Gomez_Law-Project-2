...
create temporary table if not exists Gender_StatsTemp(Country_Name varchar(20), country_code varchar(3), indicator_name string, indicator_code varchar(20),
...
load data inpath '/user/cloudera/project2/input/Gender_StatsData.txt' overwrite into table gender_statstemp;
!echo;
...
where countries.currency_unit <> null and 
coalesce(
...
gender_stats.y2015, gender_stats.y2016) <> null;
!echo;
!echo data cleansed;
!echo;
